...
public class ControlsScript : MonoBehaviour
{
    ...
    public Sprite rexrunright;
    public Sprite domrunright;
    public Sprite nikkirunright;
    public Sprite tumirunright;
    public Sprite pablorunright;
    public Sprite lisarunright;
    public Sprite mmrunright;

    public Sprite rexjumpright;
    public Sprite domjumpright;
    public Sprite nikkijumpright;
    public Sprite tumijumpright;
    public Sprite pablojumpright;
    public Sprite lisajumpright;
    public Sprite mmjumpright;

    public Sprite rexdiveright;
    public Sprite domdiveright;
    public Sprite nikkidiveright;
    public Sprite tumidiveright;
    public Sprite pablodiveright;
    public Sprite lisadiveright;
    public Sprite mmdiveright;
    ...
    //Declare the 3 different sprites that represent the control screen poses
    ...
    void Awake()
    {
        ...
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = rexrunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = rexjumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = rexdiveright;
        }
        else if (currentskin == 1) //Dom
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = domrunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = domjumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = domdiveright;
        }
        else if (currentskin == 2) //Nikki
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = nikkirunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = nikkijumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = nikkidiveright;
        }
        else if (currentskin == 3) //Tumi
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = tumirunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = tumijumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = tumidiveright;
        }
        else if ((currentskin == 4) && (ispablounlocked == 0)) //Pablo, locked
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = rexrunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = rexjumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = rexdiveright;
        }
        else if ((currentskin == 4) && (ispablounlocked == 1)) //Pablo, unlocked
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = pablorunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = pablojumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = pablodiveright;
        }
        else if ((currentskin == 5) && (islisaunlocked == 0)) //Lisa, locked
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = rexrunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = rexjumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = rexdiveright;
        }
        else if ((currentskin == 5) && (islisaunlocked == 1)) //Lisa, unlocked
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = lisarunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = lisajumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = lisadiveright;
        }
        else if ((currentskin == 6) && (ismmunlocked == 0)) //Muscle Machine, locked
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = rexrunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = rexjumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = rexdiveright;
        }
        else if ((currentskin == 6) && (ismmunlocked == 1)) //Muscle Machine, unlocked
        {
            playerrun.GetComponent<SpriteRenderer>().sprite = mmrunright;
            playerjump.GetComponent<SpriteRenderer>().sprite = mmjumpright;
            playerdive.GetComponent<SpriteRenderer>().sprite = mmdiveright;
        }
    ...
    void Start()
    {
        ...
        //Create task listeners for all the controls screen buttons
    ...
    void Update()
    {
        //If 'ESC' is pressed on the controls screen
    ...
    {
        SceneManager.LoadScene("Settings"); //Navigate backwards
    }
