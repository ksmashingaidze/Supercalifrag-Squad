...
{
    public Button socialsbtn; //Declare a new UI Button that will be used to find and store the socials button
    ...
    void Awake()
    {
        ...
        else if ((currentmap == 2) && (isabalancheunlocked == 1)) //If Abalanche is selected
        {
    ...
    void Start()
    {
        ...
        //Create task listeners for all the about screen buttons
        socialsbtn.onClick.AddListener(SocialsBtnClicked);
    ...
    void Update()
    {
        //If 'ESC' is pressed on the about screen
    ...
    void SocialsBtnClicked()
    {
        selectsound.Play(); //Play the menu select sound
        Application.OpenURL("https://www.youtube.com/channel/UCJbh-pIGBiowpZG8KZjXlXw"); //Open the developer's social media pages
